...
<div class="bg-grey-1">
  <!-- 外盘 -->
  <div class="text-h6 q-pa-sm" id="同花顺早盘视点">同花顺早盘视点 <q-badge outline color="primary" align="top" >{{this.ReportDate}} 更新</q-badge>
  </div>
  ...
  <div class="row text-caption q-pa-sm"> - 数据来源：同花顺 <br />
  - 周期：每日8:00更新同花顺早盘试点  <br />
  </div>
...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      const res = await http.get('https://stock.1dian.site/h5/data/mfthszbsd.json', {})
