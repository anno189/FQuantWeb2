...
<div class="bg-grey-1">
  <!-- 外盘 -->
  <div class="text-h6 q-pa-sm" id="格隆汇盘前要点">格隆汇盘前要点 <q-badge outline color="primary" align="top" >{{this.ReportDate}} 更新</q-badge>
  </div>
  ...
  <div class="row text-caption q-pa-sm"> - 数据来源： 格隆汇盘前要点 <br />
  - 周期：每日8点更新格隆汇盘前要点  <br />
  </div>
...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      const res = await http.get('https://stock.1dian.site/h5/data/mfglhnews293228.json', {})
