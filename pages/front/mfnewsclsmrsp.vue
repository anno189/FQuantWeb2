...
<div class="bg-grey-1">
  <!-- 外盘 -->
  <div class="text-h6 q-pa-sm" id="财联社每日收盘"> 财联社每日收盘 <q-badge outline color="primary" align="top" >{{this.ReportDate}} 更新</q-badge>
  </div>
  ...
  <div class="row text-caption q-pa-sm"> - 数据来源： 财联社每日收评 <br />
  - 周期：每日20点00分更新财联社每日收评  <br />
  </div>
...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      const res = await http.get('https://stock.1dian.site/h5/data/mfclssubject1139.json', {})
