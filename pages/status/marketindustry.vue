...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      ...
      const res1 = await http.get('https://stock.1dian.site/h5/data/marketIndustry2Count.json', params)
      //console.log(res.data)
      this.marketIndustry2CountOption = res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/marketIndustry3Count.json', params)
      this.marketIndustry3CountOption = res2.data

      const res3 = await http.get('https://stock.1dian.site/h5/data/industry_amount_industry1.json', params)
