...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      ...
      const res14 = await http.get('https://stock.1dian.site/h5/data/ind3updata.json', params)
      this.rowsins3updata = res14.data.data.ind3


      const res1 = await http.get('https://stock.1dian.site/h5/data/industryweight_wr.json', params)
      this.industryweight_wr = res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/industryweight_month.json', params)
      this.industryweight_month = res2.data

      const res3 = await http.get('https://stock.1dian.site/h5/data/industryweight_spcorr.json', params)
      this.industryweight_spcorr = res3.data

      const res4 = await http.get('https://stock.1dian.site/h5/data/industryweight_corr.json', params)
      this.industryweight_corr = res4.data

      const res5 = await http.get('https://stock.1dian.site/h5/data/industrycorr015.json', params)
      ...
      const res15 = await http.get('https://stock.1dian.site/h5/data/industrycorr0111.json', params)
      ...
      const res6 = await http.get('https://stock.1dian.site/h5/data/industrycorr0121.json', params)
      ...
      const res7 = await http.get('https://stock.1dian.site/h5/data/ins60daylevel2.json', params)
      this.ins60daylevel2 = res7.data
      const res8 = await http.get('https://stock.1dian.site/h5/data/ins2060daylevel2.json', params)
      this.ins2060daylevel2 = res8.data
      const res9 = await http.get('https://stock.1dian.site/h5/data/ins60daylevel3.json', params)
      this.ins60daylevel3 = res9.data
      const res10 = await http.get('https://stock.1dian.site/h5/data/ins2060daylevel3.json', params)
      this.ins2060daylevel3 = res10.data
      const res11 = await http.get('https://stock.1dian.site/h5/data/ins15minlevel2.json', params)
      this.ins15minlevel2 = res11.data
      const res12 = await http.get('https://stock.1dian.site/h5/data/ins30minlevel2.json', params)
      this.ins30minlevel2 = res12.data
      const res13 = await http.get('https://stock.1dian.site/h5/data/ins60minlevel2.json', params)
