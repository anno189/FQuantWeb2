...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      ...
      const res1 = await http.get('https://stock.1dian.site/h5/data/moneryfocus.json', params)
      ...
      const res2 = await http.get('https://stock.1dian.site/h5/data/moneryfocus2.json', params)
      ...
      const res3 = await http.get('https://stock.1dian.site/h5/data/moneryfocus3.json', params)
      ...
      const res4 = await http.get('https://stock.1dian.site/h5/data/moneryfocus4.json', params)
      ...
      const res5 = await http.get('https://stock.1dian.site/h5/data/moneryfocus5.json', params)
