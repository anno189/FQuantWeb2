...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      let params = {}
      const res1 = await http.get('https://stock.1dian.site/h5/data/str60p20_super_003_echarts_lines.json', params)
      this.v1lineOption=res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/str60p20_super_003_echarts_pie.json', params)
      this.v1pieOption=res2.data

      const res3 = await http.get('https://stock.1dian.site/h5/data/str60p20_super_003_position.json', params)
      
      this.rowsM = res3.data.data.position
      this.rowsN = res3.data.data.tradelog
      
      const res9 = await http.get('https://stock.1dian.site/h5/data/str60p20_super_003.html', params)
