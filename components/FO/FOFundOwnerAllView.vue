...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      let params = {}
      const res1 = await http.get('https://stock.1dian.site/h5/data/fundowner_show.json', params)
      this.foallOption=res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/fundowner_show_10years.json', params)
