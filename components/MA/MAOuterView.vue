...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      ...
      const res1 = await http.get('https://stock.1dian.site/h5/data/cnty-aty-300.json', params)
      //console.log(res.data)
      this.cntyatyOption = res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/rmbus.json', params)
