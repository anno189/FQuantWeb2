...
export default defineComponent({
  ...
  methods: {
    getData: async function () {
      const res1 = await http.get('https://stock.1dian.site/h5/data/exitstock.json', {})

      this.rowsexitprice = res1.data.data.price;
      this.rowsclearup = res1.data.data.clearup;

      const res2 = await http.get('https://stock.1dian.site/h5/data/willstoptradeoneday.json', {})
