...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      ...
      const res14 = await http.get('https://stock.1dian.site/h5/data/index3updata.json', params)
      this.rowsindex3updata = res14.data.data.index3

      const res1 = await http.get('https://stock.1dian.site/h5/data/indexweight_wr.json', params)
      this.indexweight_wr = res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/indexweight_month.json', params)
      this.indexweight_month = res2.data

      const res3 = await http.get('https://stock.1dian.site/h5/data/indexweight_spcorr.json', params)
      this.indexweight_spcorr = res3.data

      const res4 = await http.get('https://stock.1dian.site/h5/data/indexweight_corr.json', params)
      this.indexweight_corr = res4.data

      const res5 = await http.get('https://stock.1dian.site/h5/data/indexcorr015.json', params)
      this.indexcorr015 = res5.data
      this.indexcorr015.tooltip.formatter = function (params) {return params.value[3] + '(' + params.value[2] + ')';};

      const res6 = await http.get('https://stock.1dian.site/h5/data/indexcorr0121.json', params)
      this.indexcorr0121 = res6.data
      this.indexcorr0121.tooltip.formatter = function (params) {return params.value[3] + '(' + params.value[2] + ')';};


      const res7 = await http.get('https://stock.1dian.site/h5/data/indexcorr0111.json', params)
