...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      ...
      const res1 = await http.get('https://stock.1dian.site/h5/data/strong_strategyDeploy.json', params)
      //console.log(res.data)
      this.strategyDeploy01Option = res1.data

      const res2 = await http.get('https://stock.1dian.site/h5/data/str60_base_strategyDeploy.json', params)
      this.strategyDeploy02Option = res2.data

      const res3 = await http.get('https://stock.1dian.site/h5/data/str20_base_strategyDeploy.json', params)
