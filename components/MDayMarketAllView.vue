...
export default defineComponent({
  ...
  methods: {
    getServerMarketData: async function () {
      let params = {}
      const res = await http.get('https://stock.1dian.site/h5/data/today.json', params)
      ...
      const res2 = await http.get('https://stock.1dian.site/h5/data/tick.json', params)
      ...
      this.lRateCountOption.series[2].data = res2.data.data.rate.up05b
      this.lRateCountOption.series[3].data = res2.data.data.rate.do05
      this.lRateCountOption.series[4].data = res2.data.data.rate.do05b
      this.lRateCountOption.series[5].data = res2.data.data.rate.do10

      this.lSHizhiR1Option.xAxis.data = res2.data.data.min.min1.categories
      this.lSHizhiR1Option.series[0].data = res2.data.data.r1.z1
      this.lSHizhiR1Option.series[1].data = res2.data.data.r1.z2
      this.lSHizhiR1Option.series[2].data = res2.data.data.r1.z3
      this.lSHizhiR1Option.series[3].data = res2.data.data.r1.z4
      this.lSHizhiR1Option.series[4].data = res2.data.data.r1.z5
      this.lSHizhiR1Option.series[5].data = res2.data.data.r1.z6

      this.lSHizhiR2Option.xAxis.data = res2.data.data.min.min1.categories
      this.lSHizhiR2Option.series[0].data = res2.data.data.r2.z1
      this.lSHizhiR2Option.series[1].data = res2.data.data.r2.z2
      this.lSHizhiR2Option.series[2].data = res2.data.data.r2.z3
      ...
      const res4 = await http.get('https://stock.1dian.site/h5/data/RealtimeAmountTop.json', {})
  ...
  setup () {
    ...
    const lRateCountOption = ref({
      tooltip: {
          ...
          series: [
            {name:'10%',type:'line',symbol:'none',data:[]},
            {name:'5%',type:'line',symbol:'none',areaStyle: {},stack: 'Total',data:[]},
            {name:'北证5%',type:'line',symbol:'none',areaStyle: {},stack: 'Total',data:[]},
            {name:'-5%',type:'line',areaStyle: {},symbol:'none',stack: 'Total',data:[]},
            {name:'北证-5%',type:'line',symbol:'none',areaStyle: {},stack: 'Total',data:[]},
            {name:'-10%',type:'line',symbol:'none',data:[]},
            
          ]
    });

    const lSHizhiR2Option = ref({
      tooltip: {
            trigger: 'axis'
          },
          legend: {
            data:['300亿','100亿','30亿','30亿以下','成交100','平均涨幅'],
          },
          grid: {
            left: '3%',
            right: '4%',
          ...
          series: [
            {name:'300亿',type:'line',symbol:'none',data:[]},
            {name:'100亿',type:'line',symbol:'none',data:[]},
            {name:'30亿',type:'line',symbol:'none',data:[]},
            {name:'30亿以下',type:'line',symbol:'none',data:[]},
            {name:'成交100',type:'line',symbol:'none',data:[]},
            {name:'平均涨幅',type:'line',symbol:'none',data:[]},
          ]
    });

    const lSHizhiR1Option = ref({
      tooltip: {
            trigger: 'axis'
          },
          legend: {
            data:['300亿','100亿','30亿','30亿以下','成交100', '全市场'],
          },
          grid: {
            left: '3%',
            right: '4%',
          ...
          series: [
            ...
            {name:'30亿以下',type:'line',symbol:'none',data:[]},
            {name:'成交100',type:'line',symbol:'none',data:[]},
            {name:'全市场',type:'line',symbol:'none',data:[]},
          ]
    });
    ...
    const lNorthAmountOption = ref({
      tooltip: {
          ...
          series: [
            {name:'沪股通',type:'line',symbol:'none',data:[]},
            {name:'深股通',type:'line',symbol:'none',data:[]},
    ...
    */
    ...
    const columnsDataList = ref([
      ...
      { name: '金额', align: 'center', label: '金额(亿)', field: 'amount' },
      { name: '涨跌', align: 'center', label: '涨跌', field: 'rate' },
      { name: '流通市值', align: 'right', label: '流通市值', field: 'liutongshizhi' },
